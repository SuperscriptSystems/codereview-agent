...
export const generatedFileConfigSchema = z.object({
	excludeFromReview: z.boolean().default(true),
	logExcluded: z.boolean().default(true),
	ignoredPaths: z.array(z.string()).default(['__generated__', 'generated']),
	ignoredPatterns: z
		.array(z.string())
		.default(['.generated.', 'generated.', 'openapi', 'swagger', 'api-schema']),
	contentMarkers: z
		.array(z.string())
		.default([
			'auto-generated',
...
export type GeneratedFileConfig = z.infer<typeof generatedFileConfigSchema>;
...
export const reviewConfigSchema = z.object({
	...
	generatedFiles: generatedFileConfigSchema.default({
		excludeFromReview: true,
		logExcluded: true,
